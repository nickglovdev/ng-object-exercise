...
console.log(`${beatles.members[1]["name"]} was in the Beatles from ${beatles.history["formed"]} to ${beatles.history["disbanded"]}. He was born in ${beatles.members[1]["birth"]}. He constributed heavily to the ${beatles.albums["3"]} Album.`)
